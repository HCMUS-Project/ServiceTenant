...
RUN ./wait-for-it.sh postgres-container:5433 --timeout=30 --strict -- echo "Postgres is up"
RUN ./wait-for-it.sh localhost:5433 --timeout=30 --strict -- echo "Postgres is up"
